...
import { EDIT_COMMENT_REQUEST, SUB_EDIT_COMMENT_REQUEST } from '../../reducers/freeBoard';
...
const EditBox = ({ onClickMore, data }) => {
	const { me } = useSelector(state => state.user);
    const { commentArrayBool, subCommentArrayBool } = useSelector(state => state.freeBoard);
