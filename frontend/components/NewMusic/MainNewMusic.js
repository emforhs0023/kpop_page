...
import "../../assets/css/mainNewMusic.css"

const MainNewMusic = ({data, index}) => {
	...
	return (
        <>  
            <li className= {`mainMusicList${index} mainMusicList`} onClick={dataInfo(data, index)}>
                <img src={require(`../../assets/profile/${data.thumbnail}`)} alt="" className="mainNewMusicListImg"/>
                <div>
                	<p className="mainNewMusicListArtistTitle">{data.artist}</p>
                </div>
            </li>
        </>
    );
